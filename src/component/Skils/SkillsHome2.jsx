...
function SkillsHome2({ className }) {
  const [player, setPlayer] = useState(false);
  return (
    <>
      <VideoPopup player={player} setPlayer={setPlayer} />
      <section className={`skill-2-area ${className ? className : ""}`}>
        <div className="bg-image skill-bg"></div>
        <div className="container custom-container">
          <div className="row align-items-center">
            ...
            <div className="col-lg-6">
              <div className="skill-play text-right">
...
SkillsHome2.propTypes = {
  className: ProtoTypes.string,
};

export default SkillsHome2;
